    ...
    return RichText(
      text: const TextSpan(
        ...
        children: [
          ...
          TextSpan(text: "\n"),
          TextSpan(text: "Օգտատիրոջ համաձայնության հիման վրա մշակվող տվյալները պահպանվում են այն ժամկետով, որն Օգտատերը AutoZone հավելվածի իր անձնական էջում կսահմանի։ Օգտատերը ցանկացած ժամանակ կարող է իր անձնական էջում կատարել տվյալների ուղղում, հեռացում, ինչպես նաև տվյալների մշակման դադարեցում։ Օգտատիրոջ ցանկացած հրահանգի (գործողության) դեպքում հավելվածում ավտոմատացված կերպով կիրականացվի համապատասխան գործողություն։\n", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15, color: Color(0xff164866))),
          TextSpan(text: "\n"),
