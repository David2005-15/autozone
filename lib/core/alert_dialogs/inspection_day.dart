            ...
            return Dialog(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  const Image(
                    image: AssetImage("assets/Settings/RedNotice.png"),
                    width: 60,
                    height: 60,
                  ),
                  const SizedBox(
                  ...
                  Text(
                    "$autoNumber մեքենայի վարորդ, Ձեր մեքենայի տեխզննման ժամկետը ավարտվում է ${date.day.toString().padLeft(2, '0')}.${date.month.toString().padLeft(2, '0')}.${date.year}թ.-ին։",
